...
POST /_internal_api/v2/?action=api.update
{
  ...
  "entrypoints": [ {     
   "apiId" : "be829b0f-d58a-465b-b719-b39b95272a93",      
   "backup" : 1, 
...
--- error_code: 200
--- response_body eval
qr/"result":true/ and qr/"entrypoints":/
...
--- error_code: 200
--- response_body eval
qr/server_name ws-\~\^\(\?\<myid\>c237c346-7a0f-478b-bc0c-e3ca2522948f/ and qr/server_name \~\^\(\?\<myid\>c237c346-7a0f-478b-bc0c-e3ca2522948f/
--- no_error_log
