...
location /api/v1/node_install {
    ...
    content_by_lua_file /massbit/massbitroute/app/src/sites/services/api/apps/api/handlers/node_install.lua;
}

--- request
GET /api/v1/node_install?id=fd6d64f8-70fb-4c12-aa8a-bdc2805a38a4&user_id=b363ddf4-42cf-4ccf-89c2-8c42c531ac99&blockchain=eth&network=mainnet&zone=EU&data_url=https://eth-mainnet.alchemyapi.io/v2/S11tNeGBJhpOfEJODJKghuGtTfpUG2RT&app_key=J5RuUMaa2R5ouT67-aHKXg&portal_url=https://portal.massbitroute.net&env=keiko
