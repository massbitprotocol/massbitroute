define(["views/forms/order", "views/menus/export", "models/orders"], function (
  orderform,
  exports,
  orders
) {
    ...
    {},
    {
      ...
      on: {
        onChange: function () {
          ...
          if (val == "all") $$("orderData").filter("#status#", "");
          else $$("orderData").filter("#status#", val);
        },
      },
    },
  ];
    ...
    rows: [
      {
        ...
        columns: [
          ...
          { id: "date", header: "Date", sort: "string", width: 100 },
          {
            ...
            width: 45,
            template:
              "<span  style='color:#777777; cursor:pointer;' class='webix_icon fa-trash-o'></span>",
          },
        ],
        export: true,
        on: {
