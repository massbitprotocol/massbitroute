...
], function ($auth, search, mail, message, profile, menu) {
  //Top toolbar
  var mainToolbar = {
    view: "toolbar",
    css: "header",
    elements: [
      ...
      },
      {
        ...
        template: function (obj) {
          var html =
            "<div style='height:100%;width:100%;' onclick='webix.$$(\"profilePopup\").show(this)'>";
          html +=
            "<img class='photo' src='assets/imgs/photos/" +
            obj.id +
            ".png' /><span class='name'>" +
            obj.name +
            "</span>";
    ...
    rows: [
      {
        ...
        css: "title",
        template:
          "<div class='header'>#title#</div><div class='details'>( #details# )</div>",
        data: { text: "", title: "" },
      },
      {
        view: "scrollview",
