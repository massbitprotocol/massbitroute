...
_M.read_dir = _read_dir
_M.read_file = _read_file
_M.write_file = _write_file
_M.dirname = _dirname
_M.mkdirp = mkdirp
_M.inspect = inspect
_M.codegen = CodeGen
_M.get_template = _get_template
_M.git_push = _git_push
_M.show_folder = _show_folder
_M.random_string = _random_string
_M.get_uuid = _get_uuid
_M.print = _print
return _M
